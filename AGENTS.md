...
- Successful login starts one background user sync. The server also syncs users who logged in within seven days once per 24 hours; there is no ongoing hourly user auto-sync.
