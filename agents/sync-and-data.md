...
- Force rehydrate: delete rating-change and performance caches, null `standings_checked_at` + `performance` for **all** users on that contest, requeue `contest_sync_jobs`, and kick the contest sync queue.
